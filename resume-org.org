#+Title: Resume
#+Description: My resume as an org-mode document.
#+Author: Michael Zappa

* TODO this is not actually how to do latex in org-mode since the exporting takes into account the headers and such. For now stick with editing the resume.tex file.
...
#+begin_src latex
	...
	\resumeItemListStart
	\resumeItem{Relevant Coursework: Algorithms and Data Structures, Object Oriented Design, Fundamentals of Computer Science 1 and 2 (accelerated), Discrete Structures, Embedded Design, Bostonography, Linguistic Analysis.}
...
#+begin_src latex
	...
	\resumeItemListStart
	\resumeItem{Head back-end and mobile developer for a team creating a web/mobile app to facilitate the scavenger hunt put on by Northeastern University.}
	...
	\resumeItem{Used Phoenix LiveView to create an application with real-time view updates using built-in websockets.}
	\resumeItemListEnd
	\resumeProjectHeading
